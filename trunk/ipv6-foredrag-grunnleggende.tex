...
\begin{frame}[allowframebreaks]
  ...
  \item \texttt{*.169.pdf}-filene er i 16:9-format, mens \texttt{*.1610.pdf}-filene er i 16:10-format
  \framebreak
...
\begin{frame}%[allowframebreaks]
  \frametitle{Oversikt av hele foredraget}
  \framesubtitle{Del 5: DNS}
  \tableofcontents[part=5]%[pausesections]
\end{frame}

\begin{frame}%[allowframebreaks]
  \frametitle{Oversikt av hele foredraget}
  \framesubtitle{Del 6: ICMPv6}
  \tableofcontents[part=6]%[pausesections]
\end{frame}

\begin{frame}%[allowframebreaks]
  \frametitle{Oversikt av hele foredraget}
  \framesubtitle{Del 7: DHCPv6}
  \tableofcontents[part=7]%[pausesections]
\end{frame}

\begin{frame}%[allowframebreaks]
  \frametitle{Oversikt av hele foredraget}
  \framesubtitle{Del 8: OS-konfig og tunneloppsett}
  \tableofcontents[part=8]%[pausesections]
\end{frame}

\begin{frame}%[allowframebreaks]
  \frametitle{Oversikt av hele foredraget}
  \framesubtitle{Del 9: Noen RFC-er om IPv6}
...
\section*{Oversikt over del~1}
\begin{frame}%[allowframebreaks]
  \frametitle{Oversikt over del~1}
    \tableofcontents%[pausesections]
\end{frame}

\section{Hva er IPv6?}
\begin{frame}%[allowframebreaks]
  \frametitle{Hva er IPv6?}
  \pause
  \begin{itemize}[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{Hvorfor trenger vi IPv6?}
  \pause
  \begin{itemize}[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{Andre nyttige ting ved IPv6}
  \pause
  \begin{itemize}[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{IPv6 ved Fagskolen Innlandet}
  \pause
  \begin{itemize}[<+->]
...
\section*{Oversikt over del~2}
\begin{frame}[allowframebreaks]
  \frametitle{Oversikt over del~2}
    \tableofcontents%[pausesections]
\end{frame}
...
\section*{Oversikt over del~3}
\begin{frame}[allowframebreaks]
  \frametitle{Oversikt over del~3}
    \tableofcontents%[pausesections]
\end{frame}
...
\section*{Oversikt over del~4}
\begin{frame}[allowframebreaks]
  \frametitle{Oversikt over del~4}
    \tableofcontents%[pausesections]
\end{frame}
...
\begin{frame}%[allowframebreaks]
  \frametitle{Adressedemo: Hierarkisk struktur}
  %\pause
  \begin{itemize}%[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{Adressedemo: La oss forenkle adressene}
  %\pause
  \begin{itemize}%[<+->]
  \item Uninett:\\\texttt{2001:0700:0000:0000:0000:0000:0000:0000\phantom{/32}}
  \item FSI:\\\texttt{2001:0700:1100:0000:0000:0000:0000:0000\phantom{/48}}
...
\begin{frame}%[allowframebreaks]
  \frametitle{Adressedemo: Ledende nuller}
  %\pause
  \begin{itemize}%[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{Adressedemo: Fjernet ledende nuller}
  %\pause
  \begin{itemize}%[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{Adressedemo: La oss forenkle litt til}
  %\pause
  \begin{itemize}%[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{Adressedemo: To eller flere sammenhengende 16-bitgrupper med bare 0}
  %\pause
  \begin{itemize}%[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{Adressedemo: Erstattet med dobbelkolon}
  %\pause
  \begin{itemize}%[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{Adressedemo: Kompakt form}
  %\pause
  \begin{itemize}%[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{Adressedemo: Vis prefikslengde}
  %\pause
  \begin{itemize}%[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{Adressedemo: Kompakte adresser med prefikslengde}
  %\pause
  \begin{itemize}%[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{Modda IEEE EUI-64-format}
  \pause
  \begin{itemize}[<+->]
...
\section*{Oversikt over del~5}
\begin{frame}[allowframebreaks]
  \frametitle{Oversikt over del~5}
    \tableofcontents%[pausesections]
\end{frame}

\section{\texttt{AAAA} og \texttt{PTR}}
\begin{frame}[fragile]%[allowframebreaks]
  \frametitle{\texttt{AAAA} og \texttt{PTR}}
  \pause
  \begin{itemize}[<+->]
...
\end{verbatim}
  \item Forklaring:
    \begin{itemize}%[<+->]
    \item Kjeden slutter med \texttt{uninett.ip6.uninett.no.}
    \end{itemize}
  \end{itemize}
\end{frame}
...
\section*{Oversikt over del~6}
\begin{frame}[allowframebreaks]
  \frametitle{Oversikt over del~6}
    \tableofcontents%[pausesections]
\end{frame}
...
\begin{frame}%[allowframebreaks]
  \frametitle{Multicast Listener Discovery}
  \pause
  \begin{itemize}[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{Inverse Neighbor Discovery}
  \pause
  \begin{itemize}[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{Version 2 Multicast Listener Report}
  \pause
  \begin{itemize}[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{SEcure Neighbor Discovery (SEND)}
  \pause
  \begin{itemize}[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{Multicast Router Discovery}
  \pause
  \begin{itemize}[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{RPL Control Message}
  \pause
  \begin{itemize}[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{ILNPv6 Locator Update Message}
  \pause
  \begin{itemize}[<+->]
...
\section*{Oversikt over del~7}
\begin{frame}[allowframebreaks]
  \frametitle{Oversikt over del~7}
    \tableofcontents%[pausesections]
\end{frame}
...
\begin{frame}%[allowframebreaks]
  \frametitle{DHCP Unique Identifier, DUID}
  \pause
  \begin{itemize}[<+->]
...
\section*{Oversikt over del~8}
\begin{frame}[allowframebreaks]
  \frametitle{Oversikt over del~8}
    \tableofcontents%[pausesections]
\end{frame}
...
\section*{Oversikt over del~9}
\begin{frame}[allowframebreaks]
  \frametitle{Oversikt over del~9}
    \tableofcontents%[pausesections]
\end{frame}
