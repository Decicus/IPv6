...
\begin{frame}%[allowframebreaks]
  ...
  \item Network Address Translation, Carrier-Grade NAT og Shared
    Address Space er bare støttebandasje med kort utløpstid
    \begin{itemize}[<+->]
    \item Glem det
...
\begin{frame}%[allowframebreaks]
  ...
  \item Telebransjen satser fortsatt hardt på IPv4:
    \begin{itemize}[<+->]
    \item (Edge) NAT i CPE (\href{http://tools.ietf.org/html/rfc1631}{RFC~1631})
    \item Carrier-Grade NAT i stamnett (\href{http://tools.ietf.org/html/rfc6264}{RFC~6264})
    \item Shared Address Space etter behov i stamnett (\href{http://tools.ietf.org/html/rfc6598}{RFC~6598})
    \item HTTP/S-tunnelering av rubb og stubb
    \end{itemize}
  \item Før eller siden blir CGN for kostbar og komplisert å vedlikeholde
  \item 3G og 4G/LTE klarer kanskje å øke IPv6-presset (\href{http://tools.ietf.org/html/rfc6459}{RFC~6459})
  \item IPv6 er det eneste tilgjengelige og realistiske alternativet
  \end{itemize}
\end{frame}
...
\begin{frame}%[allowframebreaks]
  ...
  \item Sommeren 2007:
    ...
    \begin{itemize}[<+->]
    \item Fikk første HP-skriver med IPv6 og ville bruke IPv6
    \item Senere: IPv6-adresser på kantswitchene med
...
\begin{frame}%[allowframebreaks]
  ...
  \item Det er ingenting i veien for å «kode» IPv4-adressa inn i
    IPv6-adressa: \texttt{2001:700:1100:3:\alert{128:39:174:67}}
...
\begin{frame}%[allowframebreaks]
  ...
  \item Generér to autokonfigurerte IPv6-adresser:
    \begin{enumerate}[<+->]
    \item Konstant grensesnittidentifikator\hfill(\href{http://tools.ietf.org/html/rfc4291}{RFC~4291})
    \item Tilfeldig grensesnittidentifikator\hfill(\href{http://tools.ietf.org/html/rfc4941}{RFC~4941})
    \end{enumerate}
...
\begin{frame}%[allowframebreaks]
  ...
  %\pause
  \begin{itemize}[<+->]
  \item \href{http://tools.ietf.org/html/rfc4941}{RFC~4941} angir en
...
\begin{frame}%[allowframebreaks]
  ...
  \item Dokumentasjonsprefiks: \texttt{2001:db8::/32}
    ...
    \item Brukes for generell beskrivelse av IPv6-oppsett i lærebøker
      ...
      (\href{http://tools.ietf.org/html/rfc3849}{RFC~3849})
...
\begin{frame}%[allowframebreaks]
  ...
  \pause
  \begin{itemize}[<+->]
  \item Definert: \href{http://tools.ietf.org/html/rfc2894}{RFC~2894}
  \item Angir én ny ICMPv6-melding:
    \begin{itemize}[<+->]
    \item 138: Router Renumbering
    \end{itemize}
  \item \href{http://tools.ietf.org/html/rfc2894}{RFC~2894} angir
    følgende undertyper:
    \begin{itemize}[<+->]
