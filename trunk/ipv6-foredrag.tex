...
\begin{frame}%[allowframebreaks]
  ...
  \pause
  \begin{itemize}[<+->]
  \item En lag-3-protokoll som erstatning for IPv4
...
\begin{frame}%[allowframebreaks]
  ...
  \item Dersom \href{http://www.afrinic.net/}{AFRINIC} oppfører seg
    ...
    holde på til \href{http://www.potaroo.net/tools/ipv4/}{27.\ 
      juni 2018}
  \end{itemize}
\end{frame}
...
\begin{frame}%[allowframebreaks]
  ...
  \item \alert<13>{IPv6 er det eneste tilgjengelige og realistiske alternativet til IPv4}
  \end{itemize}
\end{frame}
