...
\begin{frame}%[allowframebreaks]
  ...
  \ifratio{43}{\includegraphics[scale=.8]{vg-dot-no-og-IPvFox-i-Mozilla-Firefox.pdf}}%
...
\begin{frame}%[allowframebreaks]
  ...
  \item Kan du ikke bruke \texttt{ipv6 multicast boundary scope}, så
    ...
    \textit{alle\/} mulige kombinasjoner av flagg!
  \item Derfor bør flagg og rekkevidde ha omvendt rekkefølge i
...
\begin{frame}%[allowframebreaks]
  ...
  \item Vanligvis lagres slike innstillinger permanent, for eksempel i \texttt{/etc/rc.conf}
    \begin{itemize}[<+->]
    \item \texttt{ifconfig\_em0\_ipv6="inet6 2001:700:1100:8008::1337 prefixlen 64"}
    \item \texttt{ipv6\_defaultrouter="2001:700:1100:8008::1"}
    \end{itemize}
  \end{itemize}
\end{frame}
