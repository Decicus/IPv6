...
\section{Midlertidige tiltak}
\begin{frame}%[allowframebreaks]
  \frametitle{Kort om IPv6}
  \framesubtitle{Midlertidige tiltak}
  \pause
  \begin{itemize}[<+->]
  \item Midlertidige tiltak:
    \begin{itemize}[<+->]
    \item Network Address Translation,
    \item Carrier-Grade NAT, og
    \item Shared Address Space (\texttt{100.64.0.0/10})
    \end{itemize}
  \item Dette er bare støttebandasje med kort utløpstid
  \item Glem det!
...
\subsection{Autentication Header}
\begin{frame}[fragile]%[allowframebreaks]
  \frametitle{Utvidelsesheadere}
...
\end{Verbatim}
  ...
  \item Feltet «RIID» settes til møtepunktets grensesnittidentifikator
    ...
    \item RIID kan ikke være \(0\), for dette skaper konflikt med
      «Subnet-Router Anycast Address» fra \rfc{3513}
    \end{itemize}
  \item Feltet «plen» settes til prefikslengden til nettverksprefikset
  \item Nettverksprefikset er ditt eget unicast-prefiks
  \item «Group ID» settes i tråd med retningslinjene til \rfc{3307}
...
\begin{frame}%[allowframebreaks]
  ...
  \begin{enumerate}[<+->]
  \item Default route:\\
    \alert{\texttt{ipv6 route ::/0 GigabitEthernet0/50 2001:700:0:8074::1}}
