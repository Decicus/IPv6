...
\begin{frame}%[allowframebreaks]
  \frametitle{Grunnleggende om adresser}
  \framesubtitle{Adressetyper: Link-local-adresser}
  \pause
  \begin{itemize}[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{Grunnleggende om adresser}
  \framesubtitle{Adressetyper: Site-local-adresser}
  \pause
  \begin{itemize}[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{Grunnleggende om adresser}
  \framesubtitle{Adressetyper: Offentlige unicast-adresser}
  \pause
  \begin{itemize}[<+->]
  \item Definert: \href{http://tools.ietf.org/html/rfc4291}{RFC~4291}
...
\begin{frame}%[allowframebreaks]
  \frametitle{Grunnleggende om adresser}
  \framesubtitle{Adressetyper: Unike, lokale, aggregerbare adresser}
  \pause
  \begin{itemize}[<+->]
...
\begin{frame}%[allowframebreaks]
  \frametitle{Grunnleggende om adresser}
  \framesubtitle{Adressetyper: Anycast-adresser}
  \pause
  \begin{itemize}[<+->]
  \item Definert: \href{http://tools.ietf.org/html/rfc4291}{RFC~4291}
...
\begin{frame}%[allowframebreaks]
  \frametitle{Grunnleggende om adresser}
  \framesubtitle{Adressetyper: Multicast-adresser}
  \pause
  \begin{itemize}[<+->]
  \item Definert: \href{http://tools.ietf.org/html/rfc4291}{RFC~4291}
...
\section*{Oversikt over del~5: DNS}
\begin{frame}[allowframebreaks]
  \frametitle{Oversikt over del~5: DNS}
    \tableofcontents%[pausesections]
\end{frame}
...
\section*{Oversikt over del~6: ICMPv6}
\begin{frame}[allowframebreaks]
  \frametitle{Oversikt over del~6: ICMPv6}
    \tableofcontents%[pausesections]
\end{frame}
...
\section*{Oversikt over del~7: DHCPv6}
\begin{frame}[allowframebreaks]
  \frametitle{Oversikt over del~7: DHCPv6}
    \tableofcontents%[pausesections]
\end{frame}
...
\section*{Oversikt over del~8: Konfigurasjon av IPv6}
\begin{frame}[allowframebreaks]
  \frametitle{Oversikt over del~8: Konfigurasjon av IPv6}
    \tableofcontents%[pausesections]
\end{frame}
...
\begin{frame}%[allowframebreaks]
  ...
  \item IPv6 må installeres manuelt i Windows XP/2003, men DNS-oppslag
    sendes over IPv4(!)
  \item IPv6 påskrudd i Windows Vista/2008 og nyere versjoner
  \item Autokonfig med tilfeldig valgt grensesnittidentifikator er
    mest vanlig
  \end{itemize}
\end{frame}
...
\section*{Oversikt over del~9: Noen RFC-er om IPv6}
\begin{frame}[allowframebreaks]
  \frametitle{Oversikt over del~9: Noen RFC-er om IPv6}
    \tableofcontents%[pausesections]
\end{frame}
