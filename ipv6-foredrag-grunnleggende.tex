...
\begin{frame}[fragile]
  ...
  \item A6-poster var foreslått som erstatning for AAAA-poster av
    \href{http://tools.ietf.org/html/rfc2874}{RFC~2874}, men merket
    som eksperimentell av
  ...
  \item En A6-post består av 2--3 ting:
    ...
    \end{itemize}
  \item Er prefikslengda satt til $0$, så er det ikke lov å oppgi henvisning
  \item Er prefikslengda satt til $128$, så kan man utelate utdraget av IPv6-adressa
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \item Det er vanlig at kundene blir tildelt \texttt{/48}- eller
    ...
    \item \texttt{/56}-bits prefiks gir $64-54=\phantom{1}8$ subnetbit $\to$ $2^{8\phantom{6}}=256$ subnett
    \end{itemize}
...
\begin{frame}
  ...
  \item Flaggene \texttt{P} og \texttt{R} gjør det mulig å enkelt lage
    egne multicast-adresser for internt bruk i organisasjonen
  \end{itemize}
\end{frame}
