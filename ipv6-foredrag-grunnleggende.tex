...
\begin{frame}[allowframebreaks]
  ...
  \item
    ...
    og
    \href{http://svnweb.ximalas.info/ipv6-foredrag-grunnleggende/trunk/ipv6-foredrag-grunnleggende.handout.4on1.pdf?view=co}{\texttt{ipv6-foredrag-grunnleggende.handout.4on1.pdf}}
...
\begin{frame}%[allowframebreaks]
  ...
  \pause
  \begin{itemize}[<+->]
  \item Mobilmarkedet viser en enorm vekst: smarttelefoner m.m.
...
\begin{frame}%[allowframebreaks]
  ...
  \item Sett at den genererte adressa er
    \texttt{2001:700:1100:3:221:70FF:FE\alert<8->{73:686E}}
  \item «Solicited-node multicast address» vil da være
    \texttt{FF02::1:FF\alert<8->{73:686E}}
  \end{itemize}
\end{frame}
...
\begin{frame}%[allowframebreaks]
  ...
  \item Det er et stort potensiale for Denial of Service --- DoS
  ...
  \item Dersom det er 2 eller flere «slabbedasker», hva da?
  \end{itemize}
\end{frame}
...
\begin{frame}%[allowframebreaks]
  ...
  \item «ICMPv6 Router Solicitation»
  \item «ICMPv6 Router Advertisement»
