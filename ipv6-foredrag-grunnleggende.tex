...
\begin{frame}%[allowframebreaks]
  ...
  \item Har eksistert siden desember 1995, spesifisert i \rfc{1883}
...
\begin{frame}%[allowframebreaks]
  ...
  \item Eksempel med Tronds lappis:
    ...
    \end{itemize}
  \item \rfc{4941} beskriver tilfeldig grensesnittidentifikator
  \item Generér to autokonfigurerte IPv6-adresser:
    \begin{enumerate}[<+->]
    \item Konstant grensesnittidentifikator\hfill\prfc{4291}
    \item Tilfeldig grensesnittidentifikator\hfill\prfc{4941}
    \end{enumerate}
...
\begin{frame}%[allowframebreaks]
  ...
  \item \texttt{sdm prefer dual-ipv4-and-ipv6 default}\hfill(Rekonfigurere \href{http://en.wikipedia.org/wiki/Content-addressable_memory}{TCAM})
  \item \texttt{end}
  \item \texttt{reload}
  \item \texttt{configure terminal}
...
\begin{frame}[allowframebreaks]
  ...
  \item \texttt{\textbf{deny}} | \texttt{\textbf{permit}
    ...
    [\texttt{\textit{operator}} [\texttt{\textit{port-number}}]]
    ...
    [\texttt{\textbf{fragments}}] [\texttt{\textbf{log}}]
    [\texttt{\textbf{log-input}}]
    [\texttt{\textbf{sequence}~\textit{value}}]
    [\texttt{\textbf{time-range}~\textit{value}}]
  \item \texttt{\textbf{deny}} | \texttt{\textbf{permit} tcp}
    ...
    \texttt{\textbf{host}~\textit{destination-ipv6-address}}\}
    [\texttt{\textit{operator}} [\texttt{\textit{port-number}}]]
    [\texttt{\textbf{ack}}] [\texttt{\textbf{dscp}~\textit{value}}]
    [\texttt{\textbf{established}}] [\texttt{\textbf{fin}}]
    [\texttt{\textbf{log}}] [\texttt{\textbf{log-input}}]
    [\texttt{\textbf{neq}} \{\texttt{\textit{port}} |
    \texttt{\textit{protocol}}\}] [\texttt{\textbf{psh}}]
    [\texttt{\textbf{range}} {\texttt{\textit{port}} |
      \texttt{\textit{protocol}}}] [\texttt{\textbf{rst}}]
    [\texttt{\textbf{sequence}~\textit{value}}]
    [\texttt{\textbf{syn}}]
  ...
  \item \texttt{\textbf{deny}} | \texttt{\textbf{permit} udp}
    ...
    \texttt{\textbf{host}~\textit{destination-ipv6-address}}\}
    [\texttt{\textit{operator}} [\texttt{\textit{port-number}}]]
    [\texttt{\textbf{dscp}~\textit{value}}] [\texttt{\textbf{log}}]
    [\texttt{\textbf{log-input}}] [\texttt{neq}
    \{\texttt{\textit{port}} | \texttt{\textit{protocol}}\}]
    [\texttt{\textbf{range}} \{\texttt{\textit{port}} |
    \texttt{\textit{protocol}}\}]
    [\texttt{\textbf{sequence}~\textit{value}}]
    [\texttt{\textbf{time-range}~\textit{name}}]
  \item \texttt{\textbf{deny}} | \texttt{\textbf{permit} icmp}
    ...
    \texttt{\textbf{host}~\textit{destination-ipv6-address}}\}
    [\texttt{\textit{operator}} [\texttt{\textit{port-number}}]]
    [\texttt{\textbf{icmp-type}} [\texttt{\textit{icmp-code}}] |
    \texttt{\textit{icmp-message}}]
    [\texttt{\textbf{dscp}~\textit{value}}] [\texttt{\textbf{log}}]
    [\texttt{\textbf{log-input}}]
    [\texttt{\textbf{sequence}~\textit{value}}]
    [\texttt{\textbf{time-range}~\textit{name}}]
